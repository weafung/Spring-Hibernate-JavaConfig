...
<!--首部-->
<div class="head">
    <img src="<%=basePath %>/statics/image/logo.png" class="logo">
    <div class="title">
...
<div class="main">
    ...
    <div class="login-box">
        ...
        <form action="" method="post">
            ...
            <!--输入密码-->
            <div class="box-input">
                <div class="box-input-title">确认密码</div>
                <input class="box-input-content" type="password" name="password_again">
            </div>
            <!--注册按钮-->
            <div>
